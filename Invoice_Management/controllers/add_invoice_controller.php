<?php
    ...
    try {
        ...
        foreach ($parts as $part) {
            ...
            $stmt = $pdo->prepare("INSERT INTO Parts (SupplierID, PartDesc, PriceBulk, SellPrice, PiecesPurch, PricePerPiece, DateCreated, Stock) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
            $stmt->execute([
                $supplierId,
                $part['partDesc'],
                $part['priceBulk'],
                ...
                $part['piecesPurch'],
                $part['pricePerPiece'],
                $_POST['dateCreated'], // Use the user's selected date instead of CURDATE()
