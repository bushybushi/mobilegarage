...
<div class="form-container">
    ...
    <div class="top-container d-flex justify-content-between align-items-center">
        ...
        <div class="btngroup text-center mt-4">
            ...
            <button type="button" class="btn btn-secondary" onclick="openForm('<?php echo $id; ?>', '<?php echo $_GET['previous_link']?>')">Cancel</button>
        </div>
        </form>
    </div>
...
function openForm(partsId, link) {
    $.get('/MGAdmin2025/managements/Parts_Management/views/parts_view.php', { id: partsId, previous_link: link }, function(response) {
