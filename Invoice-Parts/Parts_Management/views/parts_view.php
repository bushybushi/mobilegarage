...
<div class="form-container">
    ...
    <form id="partsForm">
                ...
                <div class="part-item">
                    <div class="part-info">
                        ...
                        <div class="part-pricing">
                            ...
                            $vatAmount = $subtotal * ($part['Vat'] / 100);
                        ...
                        <div class="part-pricing mt-2">
                            <span class="price-item">
                                ...
                                VAT: <?php echo number_format($part['Vat'], 2); ?>%
                            </span>
                            <span class="price-item">
        ...
        <div class="parts-actions text-center mt-4">
            <a href="edit_parts.php?id=<?php echo $partsId; ?>" class="btn btn-primary px-4">Edit</a>
            <?php if ($invoiceInfo): ?>
            ...
            <?php else: ?>
                <button type="button" class="btn btn-danger px-4" onclick="deleteParts(<?php echo $partsId; ?>)">Delete</button>
            <?php endif; ?>
        </div>
    </form>
</div>
...
<!-- Invoice Modal -->
<div class="modal fade" id="invoiceModal" tabindex="-1" role="dialog" aria-labelledby="invoiceModalLabel" aria-hidden="true" data-backdrop="static">
...
function deleteParts(partsId) {
    ...
    // Show loading state
    const deleteBtn = document.querySelector('button[onclick="deleteParts(' + partsId + ')"]');
    ...
    .then(data => {
        if (data.success) {
            // Redirect to main page where the success message will be displayed
...
function viewInvoice(invoiceId) {
    ...
    // Show loading state
    $('#invoiceContent').html('<div class="text-center"><i class="fas fa-spinner fa-spin fa-2x"></i></div>');
